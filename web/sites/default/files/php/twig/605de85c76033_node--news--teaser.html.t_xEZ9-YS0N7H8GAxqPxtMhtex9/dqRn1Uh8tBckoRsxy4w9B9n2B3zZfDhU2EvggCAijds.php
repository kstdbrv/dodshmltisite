...
<article";
  ...
  <div class=\"news-teaser__image\">
    ";
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_news", [], "any", false, false, true, 80), 80, $this->source), "html", null, true);
        echo "
  </div>
  ...
  <div class=\"news-teaser__text\">
    ";
        // line 86
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_text", [], "any", false, false, true, 86), 86, $this->source), "html", null, true);
        echo "
  </div>
  <div class=\"news-teaser__created\">
    ";
        // line 89
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "node", [], "any", false, false, true, 89), "getCreatedTime", [], "method", false, false, true, 89), 89, $this->source), "d.m.Y"), "html", null, true);
        echo "
  </div>
    <div class=\"news-teaser__tegs\">
    ";
        // line 92
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 92), 92, $this->source), "html", null, true);
        echo "
  </div>
  ";
        // line 95
...
";
    ...
    {
        return array (  80 => 95,  75 => 92,  69 => 89,  63 => 86,  57 => 83,  51 => 80,  46 => 78,  43 => 77,  41 => 74,  40 => 73,  39 => 70,);
    }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <div class=\"news-teaser__created\">
    {{ content.node.getCreatedTime()|date(\"d.m.Y\") }}
  </div>
    <div class=\"news-teaser__tegs\">
    {{ content.field_tegs }}
  </div>
...
", "sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70);
        static $filters = array("clean_class" => 73, "escape" => 78, "date" => 89);
