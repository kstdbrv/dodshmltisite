...
/* sites/default/themes/custom/start_theme/templates/content/node--photo-gallery--teaser.html.twig */
class __TwigTemplate_ee6254d5725b5f5ee3d4d65fccca611b4f071881853d9b09f313cd6e02cf4338 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div";
  ...
  <div class=\"photo-gallery__bottom\">
    <div class=\"news-teaser__statistics\">
      ";
        // line 90
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["statistics"] ?? null), 90, $this->source), "html", null, true);
        echo "
    </div>
    <div class=\"photo-gallery__created\">
      <span>";
        // line 93
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "getCreatedTime", [], "method", false, false, true, 93), 93, $this->source), "d.m.Y"), "html", null, true);
        echo "</span>  
    </div>
  </div>
  ...
  <a href=\"";
    ...
    ";
        // line 98
        $context["field_photo_text"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_photo_text", [], "any", false, false, true, 98), 98, $this->source));
        // line 99
        echo "    ";
        if (twig_length_filter($this->env, ($context["field_photo_text"] ?? null))) {
            // line 100
            echo "    <span class=\"photo-gallery__hover-text\">
     ";
            // line 101
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_photo_text", [], "any", false, false, true, 101), 101, $this->source), "html", null, true);
            echo "
    </span>
    ";
        }
...
";
    ...
    {
        return "sites/default/themes/custom/start_theme/templates/content/node--photo-gallery--teaser.html.twig";
    }
    ...
    {
        return array (  107 => 113,  104 => 110,  98 => 104,  92 => 101,  89 => 100,  86 => 99,  84 => 98,  80 => 97,  73 => 93,  67 => 90,  59 => 85,  52 => 81,  46 => 78,  43 => 77,  41 => 74,  40 => 73,  39 => 70,);
    }
...
<div{{ attributes.addClass(classes) }}>
  ...
  <a href=\"{{ url }}\" class=\"photo-gallery__link\">
    {% set field_photo_text = content.field_photo_text|render %}
    {% if field_photo_text|length %}
...
", "sites/default/themes/custom/start_theme/templates/content/node--photo-gallery--teaser.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--photo-gallery--teaser.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70, "if" => 99);
        static $filters = array("clean_class" => 73, "escape" => 78, "date" => 93, "render" => 98, "length" => 99);
