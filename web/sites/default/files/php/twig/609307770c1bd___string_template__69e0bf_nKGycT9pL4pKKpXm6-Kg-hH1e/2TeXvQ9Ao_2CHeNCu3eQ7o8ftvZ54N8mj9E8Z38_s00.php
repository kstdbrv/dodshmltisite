...
class __TwigTemplate_36e394f976c703b15b6eba4161b22d5b5922f8314cfb325daa048459f74e6dd1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <div class=\"staff__bottom\">
    <div class=\"staff__name\">{{ field_staff_sername }}</div>
   <div class=\"staff__name\">{{ field_staff_txt_name }}</div>
    <div class=\"staff__position\">{{ field_staff_position }}</div>
  </div>
{{ view_node }}
</div>", "__string_template__69e0bfa00e7cbc7be5c68f7b0e7c0edaac7e1234bb09fc45f4ceaf48ca214fa1", "");
    }
