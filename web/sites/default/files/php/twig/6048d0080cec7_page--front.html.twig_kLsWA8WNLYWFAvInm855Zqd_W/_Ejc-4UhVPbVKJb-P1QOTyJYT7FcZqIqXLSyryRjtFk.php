  ...
  <div class=\"container\">
    <div class=\"header__bottom bottom-header\">
     ...
     <div class=\"bottom-header__icons\">
      ";
        // line 29
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header__icons", [], "any", false, false, true, 29), 29, $this->source), "html", null, true);
        echo "
      ...
      ";
        ...
        if ((($context["logged_in"] ?? null) == false)) {
            // line 32
            echo "       <!-- Modal Trigger -->
        <a class=\"waves-effect waves-light btn modal-trigger\" href=\"#modal_login\">
         вход
        </a>
      ";
        }
      ...
      ";
        ...
        if (($context["logged_in"] ?? null)) {
            // line 39
            echo "        <a class=\"link unregister\" href=\"";
...
<footer class=\"footer\">
 <div class=\"container\">
  ";
        // line 62
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 62), 62, $this->source), "html", null, true);
        echo "
 </div>
</footer>
  ...
  <div id=\"modal_login\" class=\"modal\">
    ...
    <div class=\"modal-footer\">
      <i class=\"material-icons left\">login</i><input type=\"submit\" value=\"Войти\" class=\"waves-effect waves-light btn modal-trigger\">
    </div>
  </form>
</div>
  </div>
...
";
    ...
    {
        return array (  180 => 104,  138 => 62,  129 => 56,  114 => 43,  106 => 39,  104 => 38,  101 => 37,  94 => 32,  92 => 31,  87 => 29,  81 => 26,  75 => 23,  63 => 14,  57 => 11,  51 => 8,  43 => 3,  39 => 1,);
    }
  ...
  <div class=\"container\">
    <div class=\"header__bottom bottom-header\">
     ...
     <div class=\"bottom-header__icons\">
      ...
      {% if logged_in %}
        <a class=\"link unregister\" href=\"{{ path('user.logout') }}\">
         выход
        </a>
      {% endif %}
