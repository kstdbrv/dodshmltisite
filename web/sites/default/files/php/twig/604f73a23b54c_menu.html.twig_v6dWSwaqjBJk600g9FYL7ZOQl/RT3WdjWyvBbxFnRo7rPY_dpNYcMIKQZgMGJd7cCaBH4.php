        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul data-da=\"center-header__right,10,1025\" ";
...
$context["item"], "is_expanded", [], "any", false, false, true, 41)) ? ("menu-header__item_collapsed") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,                     // line 42
$context["item"], "is_collapsed", [], "any", false, false, true, 42)) ? ("menu-header__item_collapsed-real") : ("")), 3 => ((twig_get_attribute($this->env, $this->source,                     // line 43
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul data-da=\"center-header__right,10,1025\" {{ attributes.addClass('menu-header') }}>
    {% else %}
