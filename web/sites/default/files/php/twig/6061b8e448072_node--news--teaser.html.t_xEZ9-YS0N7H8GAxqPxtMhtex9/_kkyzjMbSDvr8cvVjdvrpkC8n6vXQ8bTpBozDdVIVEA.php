...
<a href=\"";
        ...
        echo "\" class=\"news-teaser__link\">Смотреть новость
  <div class=\"news-teaser__image\">
  ";
        // line 81
        $context["field_image_news"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_news", [], "any", false, false, true, 81), 81, $this->source));
        // line 82
        echo "    ";
        if (twig_length_filter($this->env, ($context["field_image_news"] ?? null))) {
            // line 83
            echo "      ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["field_image_news"] ?? null), 83, $this->source), "html", null, true);
            echo "
  ";
        } else {
            // line 85
...
";
      ...
      <div class=\"news-teaser__created\">
        <p>";
        // line 97
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "node", [], "any", false, false, true, 97), "getCreatedTime", [], "method", false, false, true, 97), 97, $this->source), "d.m.Y"), "html", null, true);
        echo "</p>  
      </div>
      ";
        // line 99
        $context["field_tegs"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 99), 99, $this->source));
        // line 100
        echo "       ";
        if (twig_length_filter($this->env, ($context["field_tegs"] ?? null))) {
         ...
         ";
            // line 102
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 102), 102, $this->source), "html", null, true);
            echo "
        </div>
       ";
        }
...
";
    ...
    {
        return array (  111 => 112,  107 => 108,  103 => 105,  97 => 102,  94 => 101,  91 => 100,  89 => 99,  84 => 97,  80 => 95,  75 => 90,  70 => 87,  66 => 85,  60 => 83,  57 => 82,  55 => 81,  50 => 79,  46 => 78,  43 => 77,  41 => 74,  40 => 73,  39 => 70,);
    }
...
<a href=\"{{ url }}\" class=\"news-teaser__link\">Смотреть новость
  <div class=\"news-teaser__image\">
...
\$entity->get('FIELD_WITH_COMMENTS')->comment_count #}", "sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 73, "escape" => 78, "render" => 81, "length" => 82, "date" => 97);
