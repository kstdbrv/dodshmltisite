...
";
        // line 94
        echo "    ";
        $context["field_tegs"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 94), 94, $this->source));
        // line 95
        echo "      ";
        ...
        ";
            // line 97
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 97), 97, $this->source), "html", null, true);
            echo "
      </div>
      ";
        }
      ...
      <div class=\"news-teaser__created\">
        <p>";
        // line 105
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "node", [], "any", false, false, true, 105), "getCreatedTime", [], "method", false, false, true, 105), 105, $this->source), "d.m.Y"), "html", null, true);
        echo "</p>  
      </div>
    </div>
  </div>  
...
";
    ...
    {
        return array (  114 => 115,  107 => 109,  100 => 105,  95 => 102,  91 => 100,  85 => 97,  82 => 96,  79 => 95,  76 => 94,  71 => 89,  66 => 86,  62 => 84,  56 => 82,  53 => 81,  51 => 80,  46 => 78,  43 => 77,  41 => 74,  40 => 73,  39 => 70,);
    }
...
{#     <div class=\"news-teaser__text\">
    ...
    <div class=\"news-teaser__bottom\">
      <div class=\"news-teaser__comments\">
        0 comm{# <p>{{ content.node.getCreatedTime()|date(\"d.m.Y\") }}</p> #}  
      </div>
      <div class=\"news-teaser__created\">
...
\$entity->get('FIELD_WITH_COMMENTS')->comment_count #}", "sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 73, "escape" => 78, "render" => 80, "length" => 81, "date" => 105);
