...
";
      ...
      <div class=\"news-teaser__created\">
        <p>";
        // line 96
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "node", [], "any", false, false, true, 96), "getCreatedTime", [], "method", false, false, true, 96), 96, $this->source), "d.m.Y"), "html", null, true);
        echo "</p>  
      </div>
      ";
        // line 98
        $context["field_tegs"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 98), 98, $this->source));
        // line 99
        echo "       ";
        if (twig_length_filter($this->env, ($context["field_tegs"] ?? null))) {
         ...
         ";
            // line 101
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tegs", [], "any", false, false, true, 101), 101, $this->source), "html", null, true);
            echo "
        </div>
       ";
        }
  ...
  <a href=\"";
        ...
        echo "\" class=\"news-teaser__link\">Смотреть новость</a>
  ";
        // line 107
        echo "</article>
...
";
    ...
    {
        return array (  110 => 111,  106 => 107,  102 => 105,  99 => 104,  93 => 101,  90 => 100,  87 => 99,  85 => 98,  80 => 96,  76 => 94,  71 => 89,  66 => 86,  62 => 84,  56 => 82,  53 => 81,  51 => 80,  46 => 78,  43 => 77,  41 => 74,  40 => 73,  39 => 70,);
    }
...
{#     <div class=\"news-teaser__text\">
  ...
  <a href=\"{{ url }}\" class=\"news-teaser__link\">Смотреть новость</a>
...
\$entity->get('FIELD_WITH_COMMENTS')->comment_count #}", "sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--news--teaser.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 73, "escape" => 78, "render" => 80, "length" => 81, "date" => 96);
