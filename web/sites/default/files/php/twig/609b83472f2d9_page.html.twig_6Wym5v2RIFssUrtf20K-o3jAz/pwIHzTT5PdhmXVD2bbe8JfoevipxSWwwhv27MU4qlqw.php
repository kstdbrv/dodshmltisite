 ...
 <div class=\"footer__top top-footer container\">
  ...
  <div class=\"footer__bottom bottom-footer\">
   <div class=\"bottom-footer__column\">
    ";
        // line 178
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_bottom_left", [], "any", false, false, true, 178), 178, $this->source), "html", null, true);
        echo "
   </div>
   <div class=\"bottom-footer__column\">
    ";
        // line 181
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "footer_bottom_right", [], "any", false, false, true, 181), 181, $this->source), "html", null, true);
        echo "
   </div>
   <div class=\"bottom-footer__column\">
    <a class=\"bottom-footer__links\" href=\"#\">Политика конфиденциальности</a>
    <a class=\"bottom-footer__links\" href=\"#\">Использование Cookie</a>
   </div>
 </div>
</footer>
