...
class __TwigTemplate_10d48f92db60904ae3616b3e548db519be846612c9fae4aed0bc442b47eb2ed1 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
   ...
   ";
    ...
    ";
        ...
        // line 45
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "edit_url", [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
        echo "
 </ul>
";
    }
...
", "sites/default/themes/custom/start_theme/templates/content/node--social.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/content/node--social.html.twig");
    }
