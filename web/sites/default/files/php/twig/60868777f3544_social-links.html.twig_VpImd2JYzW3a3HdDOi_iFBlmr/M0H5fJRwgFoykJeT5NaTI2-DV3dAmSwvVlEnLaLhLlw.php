...
class __TwigTemplate_340b8c55acadf511b8706f66e812ec9d839673cf9e697af035f7876a0ba10b1f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["url"] ?? null), 4, $this->source)) . "&title=") . $this->sandbox->ensureToStringAllowed(($context["text"] ?? null), 4, $this->source)) . "&imageUrl=") . $this->sandbox->ensureToStringAllowed(($context["img"] ?? null), 4, $this->source)), "ok" => ((((("https://connect.ok.ru/offer?url=" . $this->sandbox->ensureToStringAllowed(        // line 5
($context["url"] ?? null), 5, $this->source)) . "&title=") . $this->sandbox->ensureToStringAllowed(($context["text"] ?? null), 5, $this->source)) . "&imageUrl=") . $this->sandbox->ensureToStringAllowed(($context["img"] ?? null), 5, $this->source)), "facebook" => ("https://facebook.com/sharer/sharer.php?u=" . $this->sandbox->ensureToStringAllowed(        // line 6
...
";
    ...
    {
        return new Source("{{ attach_library('social_links/social_links') }}

{% set links = {
  'vk': 'https://vk.com/share.php?url=' ~ url ~ '&title=' ~ text ~ '&imageUrl=' ~ img,
  'ok': 'https://connect.ok.ru/offer?url=' ~ url ~ '&title=' ~ text ~ '&imageUrl=' ~ img,
  'facebook': 'https://facebook.com/sharer/sharer.php?u=' ~ url,
  'twitter': 'https://twitter.com/intent/tweet?url=' ~ url ~ '&text=' ~ text,
  'telegram': 'https://telegram.me/share/url?url=' ~ url ~ '&text=' ~ text,
  'whatsup': 'https://api.whatsapp.com/send?&text=' ~ '&text=' ~ text ~ ' ' ~ url,
...
<div{{ attributes.addClass('share') }}>
  ...
  <div class=\"share__links\">
    {% for modifier, href in links %}
      <a href=\"{{ href }}\" class=\"share__link share__link_{{ modifier }}\" rel=\"nofollow noopener\" target=\"_blank\"></a>
    {% endfor %}
  </div>
</div>
...
<div{{ attributes.addClass('share ya-share2') }}>
  <div class=\"share__links\">
    {% for modifier, href in links %}
      <a href=\"{{ href }}\" class=\"share__link share__link_{{ modifier }}\" rel=\"nofollow noopener\" target=\"_blank\"></a>
    {% endfor %}
...
<div class=\"ya-share2\" data-curtain data-shape=\"round\" data-services=\"messenger,vkontakte,facebook,odnoklassniki,telegram,twitter,whatsapp\"></div> #}", "modules/custom/social_links/templates/social-links.html.twig", "/var/www/html/web/modules/custom/social_links/templates/social-links.html.twig");
    }
