...
";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "section_2_left", [], "any", false, false, true, 101)) {
                // line 102
                echo "  <aside class=\"section-2__left wow animate__animated animate__lightSpeedInLeft\">
    ";
                // line 103
...
{% if page.section_2_left %}
  <aside class=\"section-2__left wow animate__animated animate__lightSpeedInLeft\">
    {{ page.section_2_left }}
  </aside>
{% endif %}
