...
<article";
  ...
  ";
        // line 27
        $context["field_image_target"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_target", [], "any", false, false, true, 27), 27, $this->source));
        // line 28
        echo "  ";
        if (twig_length_filter($this->env, ($context["field_image_target"] ?? null))) {
            // line 29
    ...
    ";
            // line 30
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_galary", [], "any", false, false, true, 30), 30, $this->source), "html", null, true);
            echo "
  </div>
  ";
        }
