...
class __TwigTemplate_2cf83329c6fb23d63d411596fffa9b1495200a8a8a7547a7b53c0408918d0c38 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %} 
      <ul {{ attributes.addClass('menu-footer') }}>
    {% elseif menu_level == 1 %}
      <ul class=\"menu-footer submenu\">
    {% else %}
      <ul class=\"menu-footer submenu-2\">
    {% endif %}
    {% for item in items %}
      {%
        set classes = [
          'menu-footer__item',
          item.is_expanded ? 'menu-footer__item_collapsed'
        ]
      %}
...
{% endmacro %}", "sites/default/themes/custom/start_theme/templates/navigation/menu--footer.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/navigation/menu--footer.html.twig");
    }
