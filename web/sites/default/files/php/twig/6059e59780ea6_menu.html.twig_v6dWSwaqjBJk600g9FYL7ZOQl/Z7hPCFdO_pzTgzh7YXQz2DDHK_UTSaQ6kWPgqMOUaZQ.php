        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "menu-main"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } elseif ((                // line 34
($context["menu_level"] ?? null) == 1)) {
                    // line 35
                    echo "      <ul class=\"menu-main submenu\">
    ";
                } else {
                    // line 37
                    echo "      <ul class=\"menu-main submenu-2\">
    ";
                }
                // line 39
                echo "    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo "      ";
                    // line 41
                    $context["classes"] = [0 => "menu-main__item", 1 => ((twig_get_attribute($this->env, $this->source,                     // line 43
$context["item"], "is_expanded", [], "any", false, false, true, 43)) ? ("menu-main__item_collapsed") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,                     // line 44
$context["item"], "is_collapsed", [], "any", false, false, true, 44)) ? ("menu-main__item_collapsed-real") : ("")), 3 => ((twig_get_attribute($this->env, $this->source,                     // line 45
$context["item"], "in_active_trail", [], "any", false, false, true, 45)) ? ("menu-main__item_active-trail") : (""))];
                    // line 48
                    echo "        <li ";
...
";
    ...
    {
        return array (  144 => 59,  141 => 57,  137 => 55,  130 => 53,  124 => 51,  122 => 50,  118 => 49,  113 => 48,  111 => 45,  110 => 44,  109 => 43,  108 => 41,  106 => 40,  101 => 39,  97 => 37,  93 => 35,  91 => 34,  86 => 33,  83 => 32,  80 => 31,  77 => 30,  62 => 29,  55 => 110,  49 => 61,  44 => 27,  41 => 22,  39 => 21,);
    }
...
", "sites/default/themes/custom/start_theme/templates/navigation/menu.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/navigation/menu.html.twig");
    }
