...
class __TwigTemplate_7450e5d4fc09545c963119ca5012ed9183d2dfb08056c68100304c2ba7d54272 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"news-teaser__wrapper\">
    ...
    ";
      ...
      <div class=\"news-teaser__created\">
        <span>";
        // line 102
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "getChangedTime", [], "method", false, false, true, 102), 102, $this->source), "d.m.Y"), "html", null, true);
        echo "</span>  
      </div>
    </div>
  </div>
...
<article{{ attributes.addClass(classes) }}>
  ...
  <div class=\"news-teaser__wrapper\">
    ...
    <div class=\"news-teaser__bottom\">
      ...
      <div class=\"news-teaser__created\">
        <span>{{ node.getChangedTime()|date(\"d.m.Y\") }}</span>  
      </div>
    </div>
  </div>
