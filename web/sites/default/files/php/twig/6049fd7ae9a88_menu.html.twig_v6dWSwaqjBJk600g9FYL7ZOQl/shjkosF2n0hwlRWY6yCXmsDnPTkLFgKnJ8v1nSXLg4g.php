...
class __TwigTemplate_f07e3708636a8333475e546c50c0e50099a26c21cd6c8586213768d9823b6a15 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 60
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\devel\Twig\Extension\Debug']->dump($this->env, $context));
        echo "

";
        // line 62
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\devel\Twig\Extension\Debug']->dump($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["menu_level"] ?? null), 62, $this->source)]));
    }
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo "      ";
                    // line 39
                    $context["classes"] = [0 => "menu-header__item", 1 => ((twig_get_attribute($this->env, $this->source,                     // line 41
$context["item"], "is_expanded", [], "any", false, false, true, 41)) ? ("menu-header__item_expanded") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,                     // line 42
$context["item"], "is_collapsed", [], "any", false, false, true, 42)) ? ("menu-header__item_collapsed") : ("")), 3 => ((twig_get_attribute($this->env, $this->source,                     // line 43
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-header__item_active-trail") : (""))];
                    // line 46
                    echo "      <li";
...
";
    ...
    {
        return array (  135 => 55,  131 => 53,  124 => 51,  118 => 49,  116 => 48,  112 => 47,  107 => 46,  105 => 43,  104 => 42,  103 => 41,  102 => 39,  100 => 38,  95 => 37,  91 => 35,  85 => 33,  82 => 32,  79 => 31,  76 => 30,  61 => 29,  57 => 62,  52 => 60,  49 => 59,  44 => 27,  41 => 22,  39 => 21,);
    }
  ...
  {% if items %}
    ...
    {% for item in items %}
      {%
        set classes = [
          'menu-header__item',
          item.is_expanded ? 'menu-header__item_expanded',
          item.is_collapsed ? 'menu-header__item_collapsed',
...
{{ kint(menu_level) }}", "sites/default/themes/custom/start_theme/templates/navigation/menu.html.twig", "/var/www/html/web/sites/default/themes/custom/start_theme/templates/navigation/menu.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("kint" => 60, "link" => 47);
