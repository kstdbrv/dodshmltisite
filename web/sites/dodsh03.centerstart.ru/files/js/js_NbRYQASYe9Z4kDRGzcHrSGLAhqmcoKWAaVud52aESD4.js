...
(function($){
    $.bvi = function(options) {
        ...
        function bvi_voice() {
            var isOpera = (!!window.opr && !!opr.addons) || !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0;
            var content
            isOpera ? content = '<a data-fancybox data-src="#modal_warning" href="javascript:;" href="#" class="bvi-play bvi-btn bvi-btn-outline-dark bvi-btn-sm modal-trigger">Воспроизвести</a>' +
