...
(function($){
    $.bvi = function(options) {
        ...
        function bvi_voice() {
            var isOpera = (!!window.opr && !!opr.addons) || !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0;
            var content
            isOpera ? content = '<a href="#" class="bvi-play bvi-btn bvi-btn-outline-dark bvi-btn-sm>Воспроизвести</a>' +
                 +
            ...
            if(responsiveVoice.voiceSupport() || versionIE >= 11 || versionIE >= 10 || versionIE >= 9) {
                ...
                bvi_voice.each(function(index){
                    ...
                    $(this).prepend('<div class="bvi bvi-link" data-bvi-voice-class=".' + bvi_voice_text_id + '"><div class="bvi-btn-group">' + content +  '<div class="bvi-not-supported"><p>К сожалению, чтение голосом в данном браузере не поддерживается</p></div>')
                });
