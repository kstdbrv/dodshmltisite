...
(function($){
    $.bvi = function(options) {
        ...
        function bvi_voice() {
            var isOpera = (!!window.opr && !!opr.addons) || !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0;
            var content
            isOpera ? content = '<div class="bvi-not-supported-wrapper">' + '<a href="#" class="bvi-play bvi-btn bvi-btn-outline-dark bvi-btn-sm>Воспроизвести</a>' +
            '<div class="bvi-not-supported"><p>К сожалению, чтение голосом в данном браузере не поддерживается</p></div>' + '</div>'
